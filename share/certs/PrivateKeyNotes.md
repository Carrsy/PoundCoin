...
unlocked to sign the Poundcoin-Qt.app bundle.
...
allowing somebody to distribute a Poundcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the poundcoin-qt.exe file inside the installer had not been tampered with.
